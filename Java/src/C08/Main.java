...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ArrayList<String> euler = solve(Methods.Euler, x, y, z);
        ArrayList<String> midpoint = solve(Methods.Midpoint, x, y, z);
        ArrayList<String> rk4 = solve(Methods.RK4, x, y, z);
    ...
    private static ArrayList<String> solve (Methods method, double x, double y, double z){
    ...
    private static double[] derivatives(double x, double y, double z){
